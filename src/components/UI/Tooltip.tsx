...
const Tooltip: React.FC<IPROPS> = ({ className, title, tooltipClassName }) => {
  return (
    ...
    >
      ...
      <div
        className={twMerge(
          "absolute -top-3.5 left-1/2 -translate-x-1/2 w-0 h-0 border-b-[16px] border-l-[10px] border-r-[10px] border-white border-l-transparent border-r-transparent z-20",
          tooltipClassName
        )}
      ></div>
    </div>
